...
namespace MX2
{
    public partial class SmalPlot : Form
    {
        ...
        private void a1_Click(object sender, EventArgs e)
        {
            ...
            {
                mapOfMars.tails[mapOfMars.x, mapOfMars.y, 0, 0] = new Building(menu.SelectedItem.ToString());
        ...
        private void b1_Click(object sender, EventArgs e)
        {
            ...
            {
                mapOfMars.tails[mapOfMars.x, mapOfMars.y, 1, 0] = new Building(comboBox1.SelectedItem.ToString());
                mapOfMars.buifingcon++;
            }
        ...
        private void c1_Click(object sender, EventArgs e)
        {
            ...
            {
                mapOfMars.tails[mapOfMars.x, mapOfMars.y, 2, 0] = new Building(comboBox2.SelectedItem.ToString());
                mapOfMars.buifingcon++;
            }
        ...
        private void a2_Click(object sender, EventArgs e)
        {
            ...
            {
                mapOfMars.tails[mapOfMars.x, mapOfMars.y, 0, 1] = new Building(comboBox3.SelectedItem.ToString());
                mapOfMars.buifingcon++;
            }
        ...
        private void b2_Click(object sender, EventArgs e)
        {
            ...
            {
                mapOfMars.tails[mapOfMars.x, mapOfMars.y, 1, 1] = new Building(comboBox4.SelectedItem.ToString());
                mapOfMars.buifingcon++;
            }
        ...
        private void c2_Click(object sender, EventArgs e)
        {
            ...
            {
                mapOfMars.tails[mapOfMars.x, mapOfMars.y, 2, 1] = new Building(comboBox5.SelectedItem.ToString());
                mapOfMars.buifingcon++;
            }
        ...
        private void a3_Click(object sender, EventArgs e)
        {
            ...
            {
                mapOfMars.tails[mapOfMars.x, mapOfMars.y, 0, 2] = new Building(comboBox6.SelectedItem.ToString());
                mapOfMars.buifingcon++;
            }
        ...
        private void b3_Click(object sender, EventArgs e)
        {
            ...
            {
                mapOfMars.tails[mapOfMars.x, mapOfMars.y, 1, 2] = new Building(comboBox7.SelectedItem.ToString());
                mapOfMars.buifingcon++;
            }
        ...
        private void c3_Click(object sender, EventArgs e)
        {
            ...
            {
                mapOfMars.tails[mapOfMars.x, mapOfMars.y, 2, 2] = new Building(comboBox8.SelectedItem.ToString());
                mapOfMars.buifingcon++;
            }
        ...
        private void chek_Click(object sender, EventArgs e)
        {
            ...
            {
                Tail tail = new Building(comboBox9.SelectedItem.ToString());
                ironkon.Text = tail.Iron.ToString();
                coalkon.Text = tail.Coal.ToString();
                concreatkon.Text = tail.Concreat.ToString();
                waterkon.Text = tail.Water.ToString();
            }
        }
    }
}
